...
public class SignalUtil {
     ...
     * @return false
     */
    public static void updateWireless(SignalStrength signalStrength, IndoorSignalRecord cellState) {
    ...
    public static void updateCellLocation(
            ConnectivityManager connectivityManager,
            TelephonyManager telephonyManager, IndoorSignalRecord cellState,
